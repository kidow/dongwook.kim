    ...
    >
      <div className="flex w-full flex-col px-4 xl:mr-20 xl:flex-1 xl:px-0">
        ...
        >
          ...
          >
            <div className="relative aspect-square h-full w-full overflow-hidden rounded-full ring-offset-2 duration-300 hover:ring-2 hover:ring-lime-300">
              <Link href="/">
                <Image
                  src="/avatar.svg"
                  alt="avatar"
          ...
          <div className="ml-2 mt-8 w-[calc(100%-8px)] max-w-[min(500px,100%-8px)] xl:max-w-[min(500px,calc(100vw_-_1000px))]">
            ...
            <div className="mt-3 text-muted-foreground [view-transition-name:header-description] xl:mt-3 xl:text-xl">
              비즈니스에 관심이 많은 웹 개발자 ✨
            </div>
          </div>
        </div>
