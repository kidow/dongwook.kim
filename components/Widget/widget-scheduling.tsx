...
export default function WidgetScheduling() {
  ...
  return (
    <li className="col-span-3 row-span-3 hidden h-[605px] w-full overflow-hidden rounded-3xl border border-neutral-200 bg-white xl:flex">
      <div className="flex h-full w-full divide-x divide-neutral-200">
        <div className="flex w-1/2 flex-col p-10">
          ...
          <div className="mt-8">
            ...
            <p className="mt-2 text-[20px] leading-[1.2] text-neutral-400">
              30분에서 1시간 가능합니다.
            </p>
          </div>
        ...
        <div className="w-1/2 overflow-hidden p-10">
          ...
          <p className="mt-8 text-[18px] text-neutral-400">상호작용 없는 UI 미리보기입니다.</p>
        </div>
      </div>
    </li>
  )
